...
function pozicija(elemenat) {
if(kliknutonafiguru==false ) {
    y = elemenat.cellIndex;
    x = elemenat.parentNode.rowIndex;
    x1 = x;
    y1 = y;
    if (document.getElementById('tabla').rows[x].cells[y].innerHTML != "" && player==document.getElementById('tabla').rows[x].cells[y].getElementsByTagName('img')[0].src.split('/')[5].split('_')[0]){
  ...
  else if(document.getElementById('tabla').rows[x].cells[y].getElementsByTagName('img')[0].src.split('/')[5].split('_')[0]==document.getElementById('tabla').rows[x1].cells[y1].getElementsByTagName('img')[0].src.split('/')[5].split('_')[0])
    {
        kliknutonafiguru = false;
        document.getElementById('tabla').rows[x].cells[y].style.opacity = "1";
    ...
    function potezitop(){
        ...
        for(var j=1;j<8;j++)
        {
            ...
            if(x+j<8 && top==true)
            {
                ...
                {
                    if(document.getElementById('tabla').rows[x+j].cells[y].getElementsByTagName('img')[0].src.split('/')[5].split('_')[0]== r.split('/')[5].split('_')[0])
                    {
                        top=false;
                    }
                    else
            ...
            if(y+j<8 && right==true)
            {
                ...
                {
                    if(document.getElementById('tabla').rows[x].cells[y+j].getElementsByTagName('img')[0].src.split('/')[5].split('_')[0]== r.split('/')[5].split('_')[0])
                    {
                        right=false;
                    }
                    else
...
potezitop();
    ...
    if(r.includes('konj'))
    {
        if(x+2<8)
        {
            if(y+1<8 && (document.getElementById('tabla').rows[x+2].cells[y+1].innerHTML=="" || document.getElementById('tabla').rows[x+2].cells[y+1].getElementsByTagName('img')[0].src.split('/')[5].split('_')[0]!= r.split('/')[5].split('_')[0] ))
            {
                potezi += (x+2)  + "-" + (y+1) + ",";
            }
            if(y-1>=0 && (document.getElementById('tabla').rows[x+2].cells[y-1].innerHTML=="" || document.getElementById('tabla').rows[x+2].cells[y-1].getElementsByTagName('img')[0].src.split('/')[5].split('_')[0]!= r.split('/')[5].split('_')[0]))
            {
                potezi += (x+2)  + "-" + (y-1) + ",";
            }
        }
        ...
        if(y+2<8)
        {
            if(x+1<8 && (document.getElementById('tabla').rows[x+1].cells[y+2].innerHTML=="" || document.getElementById('tabla').rows[x+1].cells[y+2].getElementsByTagName('img')[0].src.split('/')[5].split('_')[0]!= r.split('/')[5].split('_')[0]))
            {
                potezi += (x+1)  + "-" + (y+2) + ",";
            }
            if(x-1>=0 && (document.getElementById('tabla').rows[x-1].cells[y+2].innerHTML=="" || document.getElementById('tabla').rows[x-1].cells[y+2].getElementsByTagName('img')[0].src.split('/')[5].split('_')[0]!= r.split('/')[5].split('_')[0]))
            {
                potezi += (x-1)  + "-" + (y+2) + ",";
    ...
    function potezilovac()
    {
        ...
        for(var j=1;j<8;j++)
        {
            ...
            if(x+j<8 && y+j<8 && top==true)
            {
                ...
                {
                    if(document.getElementById('tabla').rows[x+j].cells[y+j].getElementsByTagName('img')[0].src.split('/')[5].split('_')[0]== r.split('/')[5].split('_')[0])
                    {
                        top=false;
                    }
                    else
